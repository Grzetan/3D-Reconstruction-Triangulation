...
protected:
    ...
    static cv::Vec3d calculateRayDirectionForPixel(const tdr::Camera* cam, const cv::Point2d& point);

    static Ray createRayForPoint(const tdr::Camera* cam, const cv::Point2d& point);
public:
